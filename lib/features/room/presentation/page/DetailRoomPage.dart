                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                'Diện tích: ' + roomDetail.size.toString() ==
                                        null
                                    ? ''
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            '${NumberFormat.decimalPattern().format(listRoom[i].price).toString()} /tháng',
                                            style: TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.bold,
                                              color:
